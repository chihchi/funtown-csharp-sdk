...
namespace Funtown.Tests
{
    ...
    {
        public static void ReturnsJson(this Mock<Funtown.FuntownClient> funtownClient, string json)
        {
            Mock<HttpWebRequestWrapper> mockRequest;
            Mock<HttpWebResponseWrapper> mockResponse;
            funtownClient.ReturnsJson(json, out mockRequest, out mockResponse);
        }

        public static void ReturnsJson(this Mock<Funtown.FuntownClient> funtownClient, string json, out Mock<HttpWebRequestWrapper> mockRequest, out Mock<HttpWebResponseWrapper> mockResponse)
        {
        ...
        public static void NoInternetConnection(this Mock<Funtown.FuntownClient> funtownClient)
        {
            Mock<HttpWebRequestWrapper> mockRequest;
            Mock<WebExceptionWrapper> mockWebException;

            funtownClient.NoInternetConnection(out mockRequest, out mockWebException);
        }

        public static void NoInternetConnection(this Mock<Funtown.FuntownClient> funtownClient, out Mock<HttpWebRequestWrapper> mockRequest, out Mock<WebExceptionWrapper> mockWebException)
        {
            mockRequest = new Mock<HttpWebRequestWrapper>();
        ...
        public static void FiddlerNoInternetConnection(this Mock<Funtown.FuntownClient> funtownClient)
        {
            Mock<HttpWebRequestWrapper> mockRequest;
            Mock<HttpWebResponseWrapper> mockResponse;
            Mock<WebExceptionWrapper> mockWebException;

            funtownClient.FiddlerNoInternetConnection(out mockRequest, out mockResponse, out mockWebException);
        }

        public static void FiddlerNoInternetConnection(this Mock<Funtown.FuntownClient> funtownClient, out Mock<HttpWebRequestWrapper> mockRequest, out Mock<HttpWebResponseWrapper> mockResponse, out Mock<WebExceptionWrapper> mockWebException)
        {
            mockRequest = new Mock<HttpWebRequestWrapper>();
            mockResponse = new Mock<HttpWebResponseWrapper>();
            mockWebException = new Mock<WebExceptionWrapper>();
            ...
            var responseStream = new MemoryStream(System.Text.Encoding.UTF8.GetBytes("Fiddler: DNS Lookup for graph.funtown.com failed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                              "));
        ...
        public static void VerifyCreateHttpWebRequest(this Mock<Funtown.FuntownClient> mockFb, Times times)
        {
            mockFb
                .Protected()
