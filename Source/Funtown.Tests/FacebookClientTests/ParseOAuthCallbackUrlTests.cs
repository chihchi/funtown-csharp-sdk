namespace Funtown.Tests._fb
{
    ...
    public class ParseOAuthCallbackUrlTests
    {
        public class GivenAUrlContainingAccessTokenAndExpiresInFragmentThen
        {
            ...
            {
                var url = new Uri("http://www.funtown.com/connect/login_success.html#access_token=123|654aaaee068db-100001327642026|sd&expires_in=0");
        ...
        public class GivenAUrlContainingErrorReasonQuerystringThen
        {
            ...
            {
                var url = new Uri("http://www.funtown.com/connect/login_success.html?error_reason=user_denied&error=access_denied&error_description=The+user+denied+your+request.");
        ...
        public class GivenCodeThen
        {
            ...
            {
                var url = new Uri("http://www.funtown.com/connect/login_success.html?code=2.XeyH7lWz33itx1R86_uBeg__.3600.1294930800-100001327642026|t8SsfSR2XI6yhBAkhX95J7p9hJ0");
