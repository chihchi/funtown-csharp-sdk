...
namespace Funtown.Tests.FuntownUtils.UrlDecode
{
    using Funtown;
    using Xunit;
    using Xunit.Extensions;

    public class GivenAUrlEncodedFuntownAccessTokenThen
    {
        ...
        [Theory(DisplayName = "UrlDecode: Given a url encoded funtown access token Then it should decode correctly")]
