...
namespace Funtown.Tests.FuntownUtils.ParseQueryParametersToDictionary
{
    ...
    public class GivenAUrlHostIsFuntownGraphWithoutQuerystringAndParameterIsEmptyThen
    {
        [Fact]
        public void CountOfParameterIs0()
        {
            string url = "http://graph.funtown.com/me/likes";
            var parameters = new Dictionary<string, object>();

            FuntownUtils.ParseQueryParametersToDictionary(url, parameters);
        ...
        public void ReturnPathEqualsPathWithoutUriHostAndDoesntStartWithForwardSlash()
        {
            ...
            var path = FuntownUtils.ParseQueryParametersToDictionary(url, parameters);
