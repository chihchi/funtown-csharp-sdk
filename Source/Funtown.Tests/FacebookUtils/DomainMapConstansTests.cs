...
namespace Funtown.Tests.FuntownUtils
{
    ...
    public class DomainMapConstansTests
    {
        ...
        {
            var result = FuntownUtils.DOMAIN_MAP_API;
        ...
        {
            var result = FuntownUtils.DOMAIN_MAP_API_READ;
        ...
        {
            var result = FuntownUtils.DOMAIN_MAP_API_VIDEO;
        ...
        {
            var result = FuntownUtils.DOMAIN_MAP_GRAPH;
        ...
        {
            var result = FuntownUtils.DOMAIN_MAP_GRAPH_VIDEO;
        ...
        {
            var result = FuntownUtils.DOMAIN_MAP_WWW;
        ...
        {
            var result = FuntownUtils.DOMAIN_MAP_APPS;
