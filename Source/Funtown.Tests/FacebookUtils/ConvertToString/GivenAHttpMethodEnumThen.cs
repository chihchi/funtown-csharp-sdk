...
namespace Funtown.Tests.FuntownUtils.ConvertToString
{
    using Funtown;
    using Xunit;
    ...
    public class GivenAHttpMethodEnumThen
    {
        ...
        {
            var result = FuntownUtils.ConvertToString(httpMethod);
        ...
        {
            var result = FuntownUtils.ConvertToString(HttpMethod.Delete);
