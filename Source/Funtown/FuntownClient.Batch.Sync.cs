//-----------------------------------------------------------------------
// <copyright file="FuntownClient.Batch.Sync.cs" company="The Outercurve Foundation">
...
namespace Funtown
{
    ...
    {
        /// <summary>
        /// Makes a batch request to the Funtown server.
        /// </summary>
        ...
        /// The json result.
        /// </returns>
        public virtual object Batch(params FuntownBatchParameter[] batchParameters)
        {
        ...
        public virtual object Batch(FuntownBatchParameter[] batchParameters, object parameters)
        {
