//-----------------------------------------------------------------------
// <copyright file="FuntownClient.OAuthResult.cs" company="The Outercurve Foundation">
...
namespace Funtown
{
    ...
    {
        /// <summary>
        /// Try parsing the url to <see cref="FuntownOAuthResult"/>.
        /// </summary>
        /// <param name="url">The url to parse</param>
        /// <param name="funtownOAuthResult">The funtown oauth result.</param>
        /// <returns>True if parse successful, otherwise false.</returns>
        [SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]        
        public virtual bool TryParseOAuthCallbackUrl(Uri url, out FuntownOAuthResult funtownOAuthResult)
        {
            funtownOAuthResult = null;

            try
            {
                funtownOAuthResult = ParseOAuthCallbackUrl(url);
                return true;
            }
            catch
            {
        ...
        /// <summary>
        /// Parse the url to <see cref="FuntownOAuthResult"/>.
        /// </summary>
        /// <param name="uri"></param>
        /// <returns></returns>
        /// <exception cref="NotImplementedException"></exception>
        [SuppressMessage("Microsoft.Naming", "CA2204:LiteralsShouldBeSpelledCorrectly")]
        public virtual FuntownOAuthResult ParseOAuthCallbackUrl(Uri uri)
        {
            ...
            if (found)
                return new FuntownOAuthResult(parameters);

            throw new InvalidOperationException("Could not parse Funtown OAuth url.");
        }

        /// <summary>
        /// Gets the Funtown OAuth login url.
        /// </summary>
        ...
        public virtual Uri GetLoginUrl(object parameters)
        {
            ...
            sb.Append(isMobile ? "https://weblogin.funtown.com.tw/oauth/oauth_mobile.php?" : "https://weblogin.funtown.com.tw/oauth/oauth.php?");
        ...
        /// <summary>
        /// Gets the Funtown OAuth logout url.
        /// </summary>
        /// <param name="parameters">
        /// The parameters.
        /// </param>
        ...
        public virtual Uri GetLogoutUrl(object parameters)
        {
            ...
            var sb = new StringBuilder();
            sb.Append("https://weblogin.funtown.com.tw/oauth/logout.php?");
