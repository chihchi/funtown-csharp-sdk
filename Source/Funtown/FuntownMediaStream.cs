//-----------------------------------------------------------------------
// <copyright file="FuntownMediaStream.cs" company="The Outercurve Foundation">
...
namespace Funtown
{
    ...
    public class FuntownMediaStream : IDisposable
    {
        /// <summary>
        ...
        /// <returns>Funtown Media Stream</returns>
        public FuntownMediaStream SetValue(Stream value)
        {
            _value = value;
            return this;
        }
