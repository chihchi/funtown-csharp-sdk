//-----------------------------------------------------------------------
// <copyright file="FuntownUploadProgressChangedEventArgs.cs" company="The Outercurve Foundation">
...
namespace Funtown
{
    ...
    /// <summary>
    /// Represents Funtown api upload progress changed event args.
    /// </summary>
    public class FuntownUploadProgressChangedEventArgs : ProgressChangedEventArgs
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FuntownUploadProgressChangedEventArgs"/> class.
        /// </summary>
        ...
        public FuntownUploadProgressChangedEventArgs(long bytesReceived, long totalBytesToReceive, long bytesSent, long totalBytesToSend, int progressPercentage, object userToken)
