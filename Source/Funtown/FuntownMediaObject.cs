//-----------------------------------------------------------------------
// <copyright file="FuntownMediaObject.cs" company="The Outercurve Foundation">
...
namespace Funtown
{
    ...
    /// </summary>
    public class FuntownMediaObject
    {
        /// <summary>
        ...
        /// <returns>Funtown Media Object</returns>
        public FuntownMediaObject SetValue(byte[] value)
        {
            _value = value;
            return this;
        }
