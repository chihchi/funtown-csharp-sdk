//-----------------------------------------------------------------------
// <copyright file="FuntownClient.Batch.Async.Tasks.cs" company="The Outercurve Foundation">
...
namespace Funtown
{
    ...
    public partial class FuntownClient
    {
        ...
        /// </returns>
        public virtual Task<object> BatchTaskAsync(params FuntownBatchParameter[] batchParameters)
        {
...
, uploadProgress
        ...
        public virtual Task<object> BatchTaskAsync(FuntownBatchParameter[] batchParameters, object userToken, CancellationToken cancellationToken)
        {
