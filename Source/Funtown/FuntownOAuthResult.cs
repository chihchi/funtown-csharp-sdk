//-----------------------------------------------------------------------
// <copyright file="FuntownOAuthResult.cs" company="The Outercurve Foundation">
...
namespace Funtown
{
    ...
    /// <summary>
    /// Represents the authentication result of Funtown.
    /// </summary>
    public class FuntownOAuthResult
    {
        /// <summary>
        /// The access token.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FuntownOAuthResult"/> class.
        /// </summary>
        protected FuntownOAuthResult()
        {
        }
        ...
        /// </remarks>
        internal FuntownOAuthResult(IDictionary<string, object> parameters)
        {
            if (parameters == null)
        ...
        /// </summary>
        /// <remarks>
        /// https://developers.funtown.com/docs/oauth/errors/
        /// </remarks>
        ...
        /// <summary>
        /// Gets the code used to exchange with Funtown to retrieve access token.
        /// </summary>
