//-----------------------------------------------------------------------
// <copyright file="FuntownClient.Batch.Async.cs" company="The Outercurve Foundation">
...
namespace Funtown
{
    ...
    public partial class FuntownClient
    {
        ...
        private const string OnlyOneAttachmentAllowedPerBatchRequest = "Only one attachement (FuntownMediaObject/FuntownMediaStream) allowed per FuntownBatchParamter.";
