//-----------------------------------------------------------------------
// <copyright file="FuntownClient.Sync.cs" company="The Outercurve Foundation">
...
namespace Funtown
{
    ...
    {
        /// <summary>
        /// Makes a request to the Funtown server.
        /// </summary>
        ...
        /// <summary>
        /// Makes a GET request to the Funtown server.
        /// </summary>
        /// <param name="path">The resource path or the resource url.</param>
        /// <returns>The json result.</returns>
        ...
        /// <summary>
        /// Makes a POST request to the Funtown server.
        /// </summary>
        /// <param name="parameters">The parameters.</param>
        /// <returns>The json result.</returns>
        ...
        /// <summary>
        /// Makes a DELETE request to the Funtown server.
        /// </summary>
        /// <param name="path">The resource path or the resource url.</param>
        /// <returns>The json result.</returns>
